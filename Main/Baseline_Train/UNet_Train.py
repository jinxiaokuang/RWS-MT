...
def get_arguments():
    ...
    parser.add_argument('--log_path', type=str, default='logs/Baseline_0719_w1/fold{}lr{}',
                        help='log path', )
    parser.add_argument('--checkpoint_path', type=str, default='checkpoints/Baseline_0719_w1/fold{}lr{}',
                        help='checkpoint path', )
    parser.add_argument('--checkpoint_name', type=str, default='checkpoint-{}.pth',
                        help='checkpoint name', )
    parser.add_argument('--summary_writer', type=str, default='logs/Baseline_0717_w1/fold{}lr{}',
                        help='checkpoint name', )
...
for epoch in range(EPOCHES):
    ...
    for iter in range(BATCHES_OF_EPOCH):
        ...
        # feat1 = ema_mid_feat.detach().cpu()
        # max_sim = -1
        # for mid_feat in ema_mid_feat_dict.items():
        #     # print('mid_feat:',mid_feat)
        #     feat2 = mid_feat[1]
        #     cos_sim = torch.nn.functional.cosine_similarity(feat1.view(1, -1), feat2.view(1, -1), eps=1e-8).item()
        #     if cos_sim > max_sim:
        #         max_sim = cos_sim
        #         pred_dice = ema_pred_dict[mid_feat[0]]
        # print('max similarity: {}, correspond dice: {}'.format(max_sim, pred_dice))
